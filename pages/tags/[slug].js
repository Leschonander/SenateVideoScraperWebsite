...
export async function getServerSideProps(context) {
  ...
  csv_data = csv_data.filter((d) => d.Tags.includes(tag));
  ...
  return {
    props: { tag: tag, data: csv_data },
  };
}

export default function HearingDashboardTags(props) {
  ...
  const [tag, updateTag] = React.useState(props.tag);
